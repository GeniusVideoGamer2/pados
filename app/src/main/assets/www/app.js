const starterChannels = [
  ...
  { name: 'beIN SPORTS 1', category: 'Sports', language: 'Turkish', source: '', note: 'Official Digiturk subscription stream URL required' },
  { name: 'beIN SPORTS 2', category: 'Sports', language: 'Turkish', source: '', note: 'Official Digiturk subscription stream URL required' },
  { name: 'beIN SPORTS 3', category: 'Sports', language: 'Turkish', source: '', note: 'Official Digiturk subscription stream URL required' },
  { name: 'beIN SPORTS 4', category: 'Sports', language: 'Turkish', source: '', note: 'Official Digiturk subscription stream URL required' },
  { name: 'beIN SPORTS 5', category: 'Sports', language: 'Turkish', source: '', note: 'Official Digiturk subscription stream URL required' },
  { name: 'beIN SPORTS MAX 1', category: 'Sports', language: 'Turkish', source: '', note: 'Official Digiturk subscription stream URL required' },
  { name: 'beIN SPORTS MAX 2', category: 'Sports', language: 'Turkish', source: '', note: 'Official Digiturk subscription stream URL required' },
  { name: 'beIN SPORTS HABER', category: 'Sports', language: 'Turkish', source: '', note: 'Official stream URL required' },
